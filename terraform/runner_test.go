...
func TestStreamPlan_ParsesEvents(t *testing.T) {
	output := strings.Join([]string{
		...
		`{"@level":"info","@message":"aws_s3_bucket.uploads: Refresh complete [id=uploads]","@module":"terraform.ui","@timestamp":"2026-04-11T09:14:46.108644+01:00","hook":{"resource":{"addr":"aws_s3_bucket.uploads","module":"","resource":"aws_s3_bucket.uploads","implied_provider":"aws","resource_type":"aws_s3_bucket","resource_name":"uploads","resource_key":null},"id_key":"id","id_value":"uploads"},"type":"refresh_complete"}`,
		`{"@level":"info","@message":"data.aws_region.current: Refresh complete after 0s [id=eu-west-2]","@module":"terraform.ui","@timestamp":"2026-04-11T09:14:46.133445+01:00","hook":{"resource":{"addr":"data.aws_region.current","module":"","resource":"data.aws_region.current","implied_provider":"aws","resource_type":"aws_region","resource_name":"current","resource_key":null},"action":"read","id_key":"id","id_value":"eu-west-2","elapsed_seconds":0},"type":"apply_complete"}`,
...
func TestStreamPlan_ContextCancellation(t *testing.T) {
	output := strings.Join([]string{
		`{"@level":"info","@message":"aws_s3_bucket.a: Refresh complete [id=a]","@module":"terraform.ui","@timestamp":"2026-04-11T09:14:46.108644+01:00","hook":{"resource":{"addr":"aws_s3_bucket.a","module":"","resource":"aws_s3_bucket.a","implied_provider":"aws","resource_type":"aws_s3_bucket","resource_name":"a","resource_key":null},"id_key":"id","id_value":"a"},"type":"refresh_complete"}`,
	}, "\n")
